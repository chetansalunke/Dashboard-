          ...
          <div className="container px-6 my-6 grid">
            ...
            <div className="flex justify-between items-center gap-3 mb-4 bg-white w-full mt-4">
              ...
              <div className="flex gap-4">
                {/* Custom Filter Dropdown (same styling as Sort By) */}
                        ...
                        <td className="px-4 py-3">
                          ...
                          >
                            ...
                            {showActionDropdown === drawing.id && (
                              <div className="absolute right-10 z-10 mt-2 w-48 bg-white border border-gray-200 rounded shadow-lg text-sm">
