        ...
        <div className="container px-6 mx-auto grid">
          ...
          <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
            <div className="flex items-center p-4 bg-white rounded-lg shadow-xs light:bg-gray-800">
              <div className="p-3 mr-4 text-orange-500 bg-orange-100 rounded-full light:text-orange-100 light:bg-orange-500">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 20 20"
            ...
            <div className="flex items-center p-4 bg-white rounded-lg shadow-xs light:bg-gray-800">
              <div className="p-3 mr-4 text-green-500 bg-green-100 rounded-full light:text-green-100 light:bg-green-500">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 20 20"
          ...
          <div className="w-full overflow-hidden rounded-lg shadow-xs">
              ...
              <table className="w-full whitespace-no-wrap">
                ...
                <tbody className="bg-white divide-y light:divide-gray-700 light:bg-gray-800">
                  ...
                  <tr className="text-gray-700 light:text-gray-400">
                    ...
                    <td className="px-4 py-3 text-sm">$ 863.45</td>
                    <td className="px-4 py-3 text-xs">
                      <span className="px-2 py-1 font-semibold leading-tight text-gray-700 bg-gray-100 rounded-full light:text-gray-100 light:bg-gray-700">
                        Expired
                      </span>
                    </td>
                    <td className="px-4 py-3 text-sm">6/10/2020</td>
            ...
            <div className="grid px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t light:border-gray-700 bg-gray-50 sm:grid-cols-9 light:text-gray-400 light:bg-gray-800">
